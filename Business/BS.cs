...
namespace MarpajarosTPVAPI.Business
{
    public class BS
    {
        ...
        public BL_TpvArticulosProveedore TpvArticulosProveedore {get; set;}
        public BL_TpvCategoria TpvCategoria {get; set;}
        public BL_TpvProveedore TpvProveedore {get; set;}
